...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/Blog/flexsearch.min.js');loadScript('/Blog/en.search-data.min.a555730a4ffc29be52fa2ffeb5b38f0948632bffdb032108af0be5840e2d8183.js',function(){input.required=false;search();});}
